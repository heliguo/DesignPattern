package com.example.designpattern.spring.aspect;

import android.content.Context;
import android.util.Log;


import com.example.designpattern.spring.annotation.PermissionDenied;
import com.example.designpattern.spring.annotation.PermissionDeniedForever;
import com.example.designpattern.spring.annotation.PermissionNeed;
import com.example.designpattern.spring.permission.ApplicationUtil;
import com.example.designpattern.spring.permission.IPermissionCallback;
import com.example.designpattern.spring.permission.PermissionUtil;
